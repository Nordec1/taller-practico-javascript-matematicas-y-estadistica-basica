...
function proyeccionPorPersona(nombrePersona) {
    ...
    const salarioNuevo = ultimoSalario + aumento;

    console.log({ultimoSalario, aumento});
    return 'El nuevo salario es de: ' + salarioNuevo;
};
...
function medianaGeneral() {
    ...
    const medianaMundial = PlatziMath.calcularMediana(listaMedianas);

    return medianaMundial;
};
